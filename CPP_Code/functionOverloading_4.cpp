...
// {
//     int r = 10, s = 20;
//     double p = 10.6, q = 20.5;
//     cout << "Interger addition is " << add(r, s) << endl;
//     cout << "Double addition is " << add(p, q) << " " << endl;
//     return 0;
// }
...
// #include <iostream>
// using namespace std;
// void fun(char a) { cout << a << " "; } // Exact match
...
// #include <iostream>
// using namespace std;
// void fun(float a) { cout << a << " "; } // type promotion  agrexact match nhi hoga to char to int  me convert ho jata hai
// void fun(int b) { cout << b << endl; }
// int main()
// {
//     char c = 'A';
